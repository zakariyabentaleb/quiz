...
CREATE TABLE `inventaire` (
  `InventoryID` tinyint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `inventaire` VALUES (1,'Clavier','Clavier mécanique pour ordinateur'),(2,'Souris','Souris optique sans fil'),(3,'Écran','Écran LED 24 pouces');
